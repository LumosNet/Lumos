...
void call_avgpool(void **params, void **ret)
{
    ...
    avgpool(im, h[0], w[0], c[0], ksize[0], stride[0], pad[0], space);
    ret[0] = (void*)space;
}
...
void call_avgpool_gradient(void **params, void **ret)
{
    ...
    avgpool_gradient(delta_l, h[0], w[0], c[0], ksize[0], stride[0], pad[0], delta_n);
    ret[0] = (void*)delta_l;
}
...
void call_maxpool_gradient(void **params, void **ret)
{
    ...
    float *delta_n = (float*)params[7];
    int *index = (int*)params[8];
    maxpool_gradient(delta_l, h[0], w[0], c[0], ksize[0], stride[0], pad[0], delta_n, index);
    ret[0] = (void*)delta_l;
}
