...
void backward_convolutional_layer_gpu(Layer l, float rate, int num)
{
    for (int i = 0; i < num; ++i)
    {
        int offset_i = i * l.inputs;
    ...
    update_convolutional_layer_gpu(l, rate, num);
}

void update_convolutional_layer_gpu(Layer l, float rate, int num)
{
    for (int i = 0; i < num; ++i)
    {
        int offset_i = i * l.inputs;
