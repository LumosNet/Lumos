...
void *create_memory(int num, DataType data_type)
{
    void *ret;
    switch (data_type){
        case CHAR:              {char *d = malloc(num*sizeof(char)); ret = d; break;}
        case UNSIGNED_CHAR:     {unsigned char *d = malloc(num*sizeof(unsigned char)); ret = d; break;}
        case SHORT:             {short *d = malloc(num*sizeof(short)); ret = d; break;}
        case UNSIGNED_SHORT:    {unsigned short *d = malloc(num*sizeof(unsigned short)); ret = d; break;}
        case INT:               {int *d = malloc(num*sizeof(int)); ret = d; break;}
        case UNSIGNED_INT:      {unsigned int *d = malloc(num*sizeof(unsigned int)); ret = d; break;}
        case LONG:              {long *d = malloc(num*sizeof(long)); ret = d; break;}
        case UNSIGNED_LONG:     {unsigned long *d = malloc(num*sizeof(unsigned long)); ret = d; break;}
        case FLOAT:             {float *d = malloc(num*sizeof(float)); ret = d; break;}
        case DOUBLE:            {double *d = malloc(num*sizeof(double)); ret = d; break;}
        case LONG_INT:          {long int *d = malloc(num*sizeof(long int)); ret = d; break;}
        case LONG_LONG:         {long long *d = malloc(num*sizeof(long long)); ret = d; break;}
        case LONG_DOUBLE:       {long double *d = malloc(num*sizeof(long double)); ret = d; break;}
    }
    return ret;
}
...
{
    switch (data_type){
        case CHAR:              {char *data = (char*)origin; char *data_x = (char*)x; full_list_with_char(data, data_x[0], num, stride, flag); break;}
        case UNSIGNED_CHAR:     {unsigned char *data = (unsigned char*)origin; unsigned char *data_x = (unsigned char*)x; full_list_with_unsigned_char(data, data_x[0], num, stride, flag); break;}
        case SHORT:             {short *data = (short*)origin; short* data_x = (short*)x; full_list_with_short(data, data_x[0], num, stride, flag); break;}
        case UNSIGNED_SHORT:    {unsigned short *data = (unsigned short*)origin; unsigned short *data_x = (unsigned short*)x; full_list_with_unsigned_short(data, data_x[0], num, stride, flag); break;}
        case INT:               {int *data = (int*)origin; int *data_x = (int*)x; full_list_with_int(data, data_x[0], num, stride, flag); break;}
        case UNSIGNED_INT:      {unsigned int *data = (unsigned int*)origin; unsigned int *data_x = (unsigned int*)x; full_list_with_unsigned_int(data, data_x[0], num, stride, flag); break;}
        case LONG:              {long *data = (long*)origin; long *data_x = (long*)x; full_list_with_long(data, data_x[0], num, stride, flag); break;}
        case UNSIGNED_LONG:     {unsigned long *data = (unsigned long*)origin; unsigned long *data_x = (unsigned long*)x; full_list_with_unsigned_long(data, data_x[0], num, stride, flag); break;}
        case FLOAT:             {float *data = (float*)origin; float *data_x = (float*)x; full_list_with_float(data, data_x[0], num, stride, flag); break;}
        case DOUBLE:            {double *data = (double*)origin; double *data_x = (double*)x; full_list_with_double(data, data_x[0], num, stride, flag); break;}
        case LONG_INT:          {long int *data = (long int*)origin; long int *data_x = (long int*)x; full_list_with_long_int(data, data_x[0], num, stride, flag); break;}
        case LONG_LONG:         {long long *data = (long long*)origin; long long *data_x = (long long*)x; full_list_with_long_long(data, data_x[0], num, stride, flag); break;}
        case LONG_DOUBLE:       {long double *data = (long double*)origin; long double *data_x = (long double*)x; full_list_with_long_double(data, data_x[0], num, stride, flag); break;}
    }
}
...
void change_pixel_in_list(void *origin, void *x, DataType data_type, int index)
{
    switch (data_type){
        ...
        case UNSIGNED_CHAR:     {unsigned char *data = (unsigned char*)origin; unsigned char *data_x = (unsigned char*)x; change_unsigned_char_in_list(data, data_x[0], index); break;}
        case SHORT:             {short *data = (short*)origin; short* data_x = (short*)x; change_short_in_list(data, data_x[0], index); break;}
        case UNSIGNED_SHORT:    {unsigned short *data = (unsigned short*)origin; unsigned short *data_x = (unsigned short*)x; change_unsigned_short_in_list(data, data_x[0], index); break;}
        case INT:               {int *data = (int*)origin; int *data_x = (int*)x; change_int_in_list(data, data_x[0], index); break;}
        case UNSIGNED_INT:      {unsigned int *data = (unsigned int*)origin; unsigned int *data_x = (unsigned int*)x; change_unsigned_int_in_list(data, data_x[0], index); break;}
        case LONG:              {long *data = (long*)origin; long *data_x = (long*)x; change_long_in_list(data, data_x[0], index); break;}
        case UNSIGNED_LONG:     {unsigned long *data = (unsigned long*)origin; unsigned long *data_x = (unsigned long*)x; change_unsigned_long_in_list(data, data_x[0], index); break;}
        case FLOAT:             {float *data = (float*)origin; float *data_x = (float*)x; change_float_in_list(data, data_x[0], index); break;}
        case DOUBLE:            {double *data = (double*)origin; double *data_x = (double*)x; change_double_in_list(data, data_x[0], index); break;}
        case LONG_INT:          {long int *data = (long int*)origin; long int *data_x = (long int*)x; change_long_int_in_list(data, data_x[0], index); break;}
        case LONG_LONG:         {long long *data = (long long*)origin; long long *data_x = (long long*)x; change_long_long_in_list(data, data_x[0], index); break;}
        case LONG_DOUBLE:       {long double *data = (long double*)origin; long double *data_x = (long double*)x; change_long_double_in_list(data, data_x[0], index); break;}
    }
}
...
void *get_pixel_in_list(void *origin, DataType data_type, int index)
{
    void *ret;
    switch (data_type){
        case CHAR:              {char *data = (char*)origin; char *a = malloc(sizeof(char)); *a = get_char_in_list(data, index); ret = a; break;}
        case UNSIGNED_CHAR:     {unsigned char *data = (unsigned char*)origin; unsigned char *a = malloc(sizeof(unsigned char)); *a = get_unsigned_char_in_list(data, index); ret = a; break;}
        case SHORT:             {short *data = (short*)origin; short *a = malloc(sizeof(short)); *a = get_short_in_list(data, index); ret = a; break;}
        case UNSIGNED_SHORT:    {unsigned short *data = (unsigned short*)origin; unsigned short *a = malloc(sizeof(unsigned short)); *a = get_unsigned_short_in_list(data, index); ret = a; break;}
        case INT:               {int *data = (int*)origin; int *a = malloc(sizeof(int)); *a = get_int_in_list(data, index); ret = a; break;}
        case UNSIGNED_INT:      {unsigned int *data = (unsigned int*)origin; unsigned int *a = malloc(sizeof(unsigned int)); *a = get_unsigned_int_in_list(data, index); ret = a; break;}
        case LONG:              {long *data = (long*)origin; long *a = malloc(sizeof(long)); *a = get_long_in_list(data, index); ret = a; break;}
        case UNSIGNED_LONG:     {unsigned long *data = (unsigned long*)origin; unsigned long *a = malloc(sizeof(unsigned long)); *a = get_unsigned_long_in_list(data, index); ret = a; break;}
        case FLOAT:             {float *data = (float*)origin; float *a = malloc(sizeof(float)); *a = get_float_in_list(data, index); ret = a; break;}
        case DOUBLE:            {double *data = (double*)origin; double *a = malloc(sizeof(double)); *a = get_double_in_list(data, index); ret = a; break;}
        case LONG_INT:          {long int *data = (long int*)origin; long int *a = malloc(sizeof(long int)); *a = get_long_int_in_list(data, index); ret = a; break;}
        case LONG_LONG:         {long long *data = (long long*)origin; long long *a = malloc(sizeof(long long)); *a = get_long_long_in_list(data, index); ret = a; break;}
        case LONG_DOUBLE:       {long double *data = (long double*)origin; long double *a = malloc(sizeof(long double)); *a = get_long_double_in_list(data, index); ret = a; break;}
    }
    return ret;
}
...
{
    switch (data_type){
        case CHAR:              {char *data = (char*)origin; memcpy_char_list((char*)ret, data, offset_r, offset_o, num); break;}
        case UNSIGNED_CHAR:     {unsigned char *data = (unsigned char*)origin; memcpy_unsigned_char_list((unsigned char*)ret, data, offset_r, offset_o, num); break;}
        case SHORT:             {short *data = (short*)origin; memcpy_short_list((short*)ret, data, offset_r, offset_o, num); break;}
        case UNSIGNED_SHORT:    {unsigned short *data = (unsigned short*)origin; memcpy_unsigned_short_list((unsigned short*)ret, data, offset_r, offset_o, num); break;}
        case INT:               {int *data = (int*)origin; memcpy_int_list((int*)ret, data, offset_r, offset_o, num); break;}
        case UNSIGNED_INT:      {unsigned int *data = (unsigned int*)origin; memcpy_unsigned_int_list((unsigned int*)ret, data, offset_r, offset_o, num); break;}
        case LONG:              {long *data = (long*)origin; memcpy_long_list((long*)ret, data, offset_r, offset_o, num); break;}
        case UNSIGNED_LONG:     {unsigned long *data = (unsigned long*)origin; memcpy_unsigned_long_list((unsigned long*)ret, data, offset_r, offset_o, num); break;}
        case FLOAT:             {float *data = (float*)origin; memcpy_float_list((float*)ret, data, offset_r, offset_o, num); break;}
        case DOUBLE:            {double *data = (double*)origin; memcpy_double_list((double*)ret, data, offset_r, offset_o, num); break;}
        case LONG_INT:          {long int *data = (long int*)origin; memcpy_long_int_list((long int*)ret, data, offset_r, offset_o, num); break;}
        case LONG_LONG:         {long long *data = (long long*)origin; memcpy_long_long_list((long long*)ret, data, offset_r, offset_o, num); break;}
        case LONG_DOUBLE:       {long double *data = (long double*)origin; memcpy_long_double_list((long double*)ret, data, offset_r, offset_o, num); break;}
    }
}
...
void *sum_list(void *origin, DataType data_type, int offset, int len)
{
    void *ret;
    switch (data_type){
        case CHAR:              {char *data = (char*)origin; int *a = malloc(sizeof(int)); *a = sum_char_list(data, offset, len); ret = a; break;}
        case UNSIGNED_CHAR:     {unsigned char *data = (unsigned char*)origin; unsigned int *a = malloc(sizeof(unsigned int)); *a = sum_unsigned_char_list(data, offset, len); ret = a; break;}
        case SHORT:             {short *data = (short*)origin; short *a = malloc(sizeof(short)); *a = sum_short_list(data, offset, len); ret = a; break;}
        case UNSIGNED_SHORT:    {unsigned short *data = (unsigned short*)origin; unsigned short *a = malloc(sizeof(unsigned short)); *a = sum_unsigned_short_list(data, offset, len); ret = a; break;}
        case INT:               {int *data = (int*)origin; int *a = malloc(sizeof(int)); *a = sum_int_list(data, offset, len); ret = a; break;}
        case UNSIGNED_INT:      {unsigned int *data = (unsigned int*)origin; unsigned int *a = malloc(sizeof(unsigned int)); *a = sum_unsigned_int_list(data, offset, len); ret = a; break;}
        case LONG:              {long *data = (long*)origin; long *a = malloc(sizeof(long)); *a = sum_long_list(data, offset, len); ret = a; break;}
        case UNSIGNED_LONG:     {unsigned long *data = (unsigned long*)origin; unsigned long *a = malloc(sizeof(unsigned long)); *a = sum_unsigned_long_list(data, offset, len); ret = a; break;}
        case FLOAT:             {float *data = (float*)origin; float *a = malloc(sizeof(float)); *a = sum_float_list(data, offset, len); ret = a; break;}
        case DOUBLE:            {double *data = (double*)origin; double *a = malloc(sizeof(double)); *a = sum_double_list(data, offset, len); ret = a; break;}
        case LONG_INT:          {long int *data = (long int*)origin; long int *a = malloc(sizeof(long int)); *a = sum_long_int_list(data, offset, len); ret = a; break;}
        case LONG_LONG:         {long long *data = (long long*)origin; long long *a = malloc(sizeof(long long)); *a = sum_long_long_list(data, offset, len); ret = a; break;}
        case LONG_DOUBLE:       {long double *data = (long double*)origin; long double *a = malloc(sizeof(long double)); *a = sum_long_double_list(data, offset, len); ret = a; break;}
    }
    return ret;
}
...
void *multing_list(void *origin, DataType data_type, int offset, int len)
{
    void *ret;
    switch (data_type){
        case CHAR:              {char *data = (char*)origin; int *a = malloc(sizeof(int)); *a = multing_char_list(data, offset, len); ret = a; break;}
        case UNSIGNED_CHAR:     {unsigned char *data = (unsigned char*)origin; unsigned int *a = malloc(sizeof(unsigned int)); *a = multing_unsigned_char_list(data, offset, len); ret = a; break;}
        case SHORT:             {short *data = (short*)origin; short *a = malloc(sizeof(short)); *a = multing_short_list(data, offset, len); ret = a; break;}
        case UNSIGNED_SHORT:    {unsigned short *data = (unsigned short*)origin; unsigned short *a = malloc(sizeof(unsigned short)); *a = multing_unsigned_short_list(data, offset, len); ret = a; break;}
        case INT:               {int *data = (int*)origin; int *a = malloc(sizeof(int)); *a = multing_int_list(data, offset, len); ret = a; break;}
        case UNSIGNED_INT:      {unsigned int *data = (unsigned int*)origin; unsigned int *a = malloc(sizeof(unsigned int)); *a = multing_unsigned_int_list(data, offset, len); ret = a; break;}
        case LONG:              {long *data = (long*)origin; long *a = malloc(sizeof(long)); *a = multing_long_list(data, offset, len); ret = a; break;}
        case UNSIGNED_LONG:     {unsigned long *data = (unsigned long*)origin; unsigned long *a = malloc(sizeof(unsigned long)); *a = multing_unsigned_long_list(data, offset, len); ret = a; break;}
        case FLOAT:             {float *data = (float*)origin; float *a = malloc(sizeof(float)); *a = multing_float_list(data, offset, len); ret = a; break;}
        case DOUBLE:            {double *data = (double*)origin; double *a = malloc(sizeof(double)); *a = multing_double_list(data, offset, len); ret = a; break;}
        case LONG_INT:          {long int *data = (long int*)origin; long int *a = malloc(sizeof(long int)); *a = multing_long_int_list(data, offset, len); ret = a; break;}
        case LONG_LONG:         {long long *data = (long long*)origin; long long *a = malloc(sizeof(long long)); *a = multing_long_long_list(data, offset, len); ret = a; break;}
        case LONG_DOUBLE:       {long double *data = (long double*)origin; long double *a = malloc(sizeof(long double)); *a = multing_long_double_list(data, offset, len); ret = a; break;}
    }
    return ret;
}
